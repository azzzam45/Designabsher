...
import ministryLogo from "figma:asset/59146a0de59733b1b8e18bea395729bf235530c3.png";
import vision2030 from "figma:asset/2158dacd4b1c0d279240e77a718a741b1746d05b.png";
import newVision2030 from "figma:asset/fda363a41951d8f8db100b0d2dc87beb2ca66465.png";
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-2.5">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <img src={ministryLogo} alt="وزارة الداخلية" className="h-14 w-14 object-contain" />
          </div>
        </div>
      </div>
    </header>
